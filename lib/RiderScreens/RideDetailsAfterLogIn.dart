...
import 'package:Deliver_Rider/widgets/warningOnRidesDetailsScreen.dart';
...
class RideDetailsAfterLogInScreen extends StatefulWidget {
  final String userType;
  final String userFleetId;
  final String parentID;
  const RideDetailsAfterLogInScreen(
      {super.key,
  ...
  @override
  State<RideDetailsAfterLogInScreen> createState() =>
      _RideDetailsAfterLogInScreenState();
}

class _RideDetailsAfterLogInScreenState
    extends State<RideDetailsAfterLogInScreen> {
    ...
    if (_key.currentState!.validate()) {
      if (bikeCategoryID == -1) {
        ...
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (context) => RideDetailsAfterLogInSecondScreen(
