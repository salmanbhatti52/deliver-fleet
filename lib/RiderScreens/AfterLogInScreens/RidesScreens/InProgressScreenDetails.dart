      ...
      Navigator.of(context).push(
        MaterialPageRoute(
          builder: (context) => UserToUserChat(
            ...
            address: widget.inProgressRidesList?.bookings
                ?.bookings_destinations?[0].pickup_address,
            clientID: widget.inProgressRidesList!.bookings!.users_customers!
                .users_customers_id
                .toString(),
          ),
        ),
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              widget.inProgressRidesList2![i].bookings!
                                  .bookings_destinations![i].receiver_phone!,
                              style: GoogleFonts.inter(
                                fontSize: 14,
                                fontWeight: FontWeight.w500,
                                color: black,
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: AutoSizeText(
                              widget.inProgressRidesList2![i].bookings!
                                  .bookings_destinations![i].destin_address!,
                              minFontSize: 12,
                              maxLines: 3,
                              overflow: TextOverflow.ellipsis,
                              style: GoogleFonts.inter(
                        ...
                        child: SizedBox(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                widget.inProgressRidesList2![i].bookings!
                                    .bookings_destinations![i].destin_time!,
                                style: GoogleFonts.inter(
                                  fontSize: 10,
