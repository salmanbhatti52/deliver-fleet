...
import 'package:Deliver_Rider/widgets/ProfileDetailsFromDrawerProfile.dart';
                                      ...
                                      Container(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: getUserProfileResponse!.data!
                                                  ...
                                                  null
                                              ? Image.network(
                                                  'https://deliver.eigix.net/public/${getUserProfileResponse!.data!.driving_license_front_image}',
                                                  fit: BoxFit.cover,
                                      ...
                                      Container(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: getUserProfileResponse!.data!
                                                  ...
                                                  null
                                              ? Image.network(
                                                  'https://deliver.eigix.net/public/${getUserProfileResponse!.data!.driving_license_back_image}',
                                                  fit: BoxFit.cover,
                                                  errorBuilder: (BuildContext
                                                          context,
                                                      Object exception,
