...
import 'package:deliver_partner/RiderScreens/DrawerScreens/Accepted%20Rides/acceptedRidesDetails.dart';
...
import 'package:deliver_partner/models/API_models/acceptedRidesModels.dart';
...
class _AcceptedRidesState extends State<AcceptedRides> {
  ...
  AcceptedRidesModel acceptedRidesModel = AcceptedRidesModel();
  Future<void> getAcceptedScheduledRides() async {
    ...
    var url =
        Uri.parse('https://deliverbygfl.com/api/get_bookings_accepted_fleet');
    ...
    if (res.statusCode == 200) {
      print(resBody);
      acceptedRidesModel = acceptedRidesModelFromJson(resBody);
      setState(() {
        isLoading = false;
      });
    } else {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: isLoading
            ...
            : acceptedRidesModel.data != null
                ? ListView.builder(
                    itemCount: acceptedRidesModel.data
                        ?.length, // replace "yourList" with your actual list
                    itemBuilder: (context, index) {
                      final itemList = acceptedRidesModel.data![index];
                      return Container(
                                ...
                                GestureDetector(
                                  onTap: () {
                                    ...
                                    Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                            builder: (context) => AcceptedRidesPage(
