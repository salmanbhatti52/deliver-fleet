                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          child: ClipRRect(
                            borderRadius: BorderRadius.circular(15),
                            // child: widget.completedRidesModel.bookings!.users_customers!.profile_pic != null
                            //     ? Image.network(
                              ...
                              SizedBox(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    //         ratings: widget.completedRidesModel.users_fleet!.bookings_ratings == null
                                    //             ? '0.0'
                          ...
                          children: [
                            ...
                            Expanded(
                              child: CompletedRidesDestinationsWidget(
                                ...
                                time: "time",
                                fare: "fare",
                                // destination: widget.completedRidesModel.bookings!.bookings_destinations![0]!.destin_address!,
                                // distance: widget.completedRidesModel.bookings!.bookings_destinations![0]!.destin_distance!,
                                // time: widget.completedRidesModel.bookings!.bookings_destinations![0]!.destin_time!,
