...
class ScheduledRidesDetailsPage extends StatefulWidget {
  final int? index;
  final String userID;
  final String? bookingID;

  const ScheduledRidesDetailsPage({
    super.key,
    this.index,
  ...
  @override
  State<ScheduledRidesDetailsPage> createState() =>
      _ScheduledRidesDetailsPageState();
}

class _ScheduledRidesDetailsPageState extends State<ScheduledRidesDetailsPage> {
                                                              ...
                                                              Row(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Text(
                                                                    DateFormat(
                                                                            'h:mm a')
                                                                        .format(DateTime.parse(updateBookingStatusModel
                                                                            .data!
                                                                            .dateAdded
                                                                            .toString())),
                                                                    style: GoogleFonts
