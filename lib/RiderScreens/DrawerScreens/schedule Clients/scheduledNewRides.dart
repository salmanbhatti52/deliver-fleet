...
class ScheduledNewRides extends StatefulWidget {
  const ScheduledNewRides({super.key});

  @override
  State<ScheduledNewRides> createState() => _ScheduledNewRidesState();
}

class _ScheduledNewRidesState extends State<ScheduledNewRides> {
  bool opened = false;
  bool closed = false;
  int selectedIndex = -1;
  String? name;
  ...
  ScheduledRides scheduledRides = ScheduledRides();
  Future<void> getScheduledRides() async {
  ...
  Widget build(BuildContext context) {
    return isLoading
        ...
        : scheduledRides.data != null
            ? Column(
                children: [
                  Expanded(
                    child: ListView.builder(
                        itemCount: scheduledRides.data
                            ?.length, // replace "yourList" with your actual list
                        itemBuilder: (context, index) {
                          final itemList = scheduledRides.data![index];
                          return Container(
                                ...
                                Row(
                                  ...
                                  children: [
                                    GestureDetector(
                                      ...
                                      child: SeeDetailsOnCompletedRidesButton(
                                          context),
                                    ),
                                  ],
                                ),
