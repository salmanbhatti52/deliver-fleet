...
GetSupportChatModel getSupportChatModelFromJson(String str) =>
    GetSupportChatModel.fromJson(json.decode(str));

String getSupportChatModelToJson(GetSupportChatModel data) =>
...
class GetSupportChatModel {
  ...
  factory GetSupportChatModel.fromJson(Map<String, dynamic> json) =>
      GetSupportChatModel(
        status: json["status"],
        data: json["data"] != null
