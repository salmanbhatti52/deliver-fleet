...
import '../API models/GetAllAvailableVehicles.dart';

class GetFleetVehicleRequestByIdModel {
  ...
  factory GetFleetVehicleRequestByIdModel.fromJson(Map<String, dynamic> json) {
    return GetFleetVehicleRequestByIdModel(
