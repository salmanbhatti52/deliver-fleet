...
//
//     final getFleetVehiclesAvailable = getFleetVehiclesAvailableFromJson(jsonString);

import 'dart:convert';

GetFleetVehiclesAvailable getFleetVehiclesAvailableFromJson(String str) =>
    GetFleetVehiclesAvailable.fromJson(json.decode(str));

String getFleetVehiclesAvailableToJson(GetFleetVehiclesAvailable data) =>
    json.encode(data.toJson());

class GetFleetVehiclesAvailable {
  String? status;
  List<Datum>? data;
  ...
  factory GetFleetVehiclesAvailable.fromJson(Map<String, dynamic> json) =>
      GetFleetVehiclesAvailable(
        status: json["status"],
...
class Datum {
  ...
  String status;
  Vehicles vehicles;
  UsersFleetVehiclesAssigned? usersFleetVehiclesAssigned;
  ...
  Datum({
    ...
    required this.vehicles,
     this.usersFleetVehiclesAssigned,
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        usersFleetVehiclesAssigned: json["users_fleet_vehicles_assigned"] != null 
          ? UsersFleetVehiclesAssigned.fromJson(json["users_fleet_vehicles_assigned"])
          : null,
  ...
  Map<String, dynamic> toJson() => {
        ...
        "users_fleet_vehicles_assigned": usersFleetVehiclesAssigned!.toJson(),
...
class UsersFleetVehiclesAssigned {
  int usersFleetVehiclesAssignedId;
  int usersFleetId;
  int vehiclesId;
  int usersFleetVehiclesId;
  DateTime dateAdded;
  ...
  UsersFleetVehiclesAssigned({
    required this.usersFleetVehiclesAssignedId,
    required this.usersFleetId,
    required this.vehiclesId,
    required this.usersFleetVehiclesId,
    required this.dateAdded,
  ...
  factory UsersFleetVehiclesAssigned.fromJson(Map<String, dynamic> json) =>
      UsersFleetVehiclesAssigned(
        usersFleetVehiclesAssignedId: json["users_fleet_vehicles_assigned_id"],
        usersFleetId: json["users_fleet_id"],
        vehiclesId: json["vehicles_id"],
        usersFleetVehiclesId: json["users_fleet_vehicles_id"],
        dateAdded: DateTime.parse(json["date_added"]),
  ...
  Map<String, dynamic> toJson() => {
        "users_fleet_vehicles_assigned_id": usersFleetVehiclesAssignedId,
        "users_fleet_id": usersFleetId,
        "vehicles_id": vehiclesId,
        "users_fleet_vehicles_id": usersFleetVehiclesId,
        "date_added": dateAdded.toIso8601String(),
