...
GetOnGoingRides getOnGoingRidesFromJson(String str) => GetOnGoingRides.fromJson(json.decode(str));

String getOnGoingRidesToJson(GetOnGoingRides data) => json.encode(data.toJson());
...
class GetOnGoingRides {
    ...
    factory GetOnGoingRides.fromJson(Map<String, dynamic> json) => GetOnGoingRides(
        status: json["status"],
