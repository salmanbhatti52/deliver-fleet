...
//
//     final completedRideBookingModels = completedRideBookingModelsFromJson(jsonString);

import 'dart:convert';

CompletedRideBookingModels completedRideBookingModelsFromJson(String str) =>
    CompletedRideBookingModels.fromJson(json.decode(str));

String completedRideBookingModelsToJson(CompletedRideBookingModels data) =>
    json.encode(data.toJson());

class CompletedRideBookingModels {
  String? status;
  List<Datum>? data;

  CompletedRideBookingModels({
    this.status,
    this.data,
  });

  factory CompletedRideBookingModels.fromJson(Map<String, dynamic> json) =>
      CompletedRideBookingModels(
        status: json["status"],
