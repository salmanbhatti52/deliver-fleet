...
//
//     final completedBookingsModel = completedBookingsModelFromJson(jsonString);

import 'dart:convert';

CompletedBookingsModel completedBookingsModelFromJson(String str) =>
    CompletedBookingsModel.fromJson(json.decode(str));

String completedBookingsModelToJson(CompletedBookingsModel data) =>
    json.encode(data.toJson());

class CompletedBookingsModel {
  String? status;
  List<Datum>? data;

  CompletedBookingsModel({
    this.status,
    this.data,
  });

  factory CompletedBookingsModel.fromJson(Map<String, dynamic> json) =>
      CompletedBookingsModel(
        status: json["status"],
