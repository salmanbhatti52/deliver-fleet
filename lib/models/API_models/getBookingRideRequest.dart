...
//
//     final getBookingRideRequest = getBookingRideRequestFromJson(jsonString);

import 'dart:convert';

GetBookingRideRequest getBookingRideRequestFromJson(String str) => GetBookingRideRequest.fromJson(json.decode(str));

String getBookingRideRequestToJson(GetBookingRideRequest data) => json.encode(data.toJson());

class GetBookingRideRequest {
    String? status;
    List<Datum>? data;

    GetBookingRideRequest({
         this.status,
         this.data,
    });

    factory GetBookingRideRequest.fromJson(Map<String, dynamic> json) => GetBookingRideRequest(
        status: json["status"],
...
class Datum {
    ...
    factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        bookingsCancellationsReasonsId: json["bookings_cancellations_reasons_id"],
...
class BookingsDestination {
    ...
    factory BookingsDestination.fromJson(Map<String, dynamic> json) => BookingsDestination(
        ...
        bookingsDestinationsStatus: ServiceTypes.fromJson(json["bookings_destinations_status"]),
    );
