...
UpdateRiderStatusModel updateRiderStatusModelFromJson(String str) => UpdateRiderStatusModel.fromJson(json.decode(str));

String updateRiderStatusModelToJson(UpdateRiderStatusModel data) => json.encode(data.toJson());
...
class UpdateRiderStatusModel {
  ...
  factory UpdateRiderStatusModel.fromJson(Map<String, dynamic> json) => UpdateRiderStatusModel(
    status: json["status"],
