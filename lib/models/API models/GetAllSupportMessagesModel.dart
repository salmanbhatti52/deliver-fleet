class UserData {
  int? users_fleet_id, parent_id, users_system_roles_id;
  ...
  factory UserData.fromJson(Map<String, dynamic> json) {
    return UserData(
      ...
      users_system_roles_id: json["users_system_roles_id"],
      status: json["status"],
    );
  }
}

class GetAllSupportMessagesModel {
  int? chat_messages_live_id, sender_id, receiver_id;
  String? sender_type,
      receiver_type,
      message_type,
      message,
  ...
  GetAllSupportMessagesModel(
      {this.chat_messages_live_id,
      this.sender_id,
      this.receiver_id,
      this.sender_type,
      this.receiver_type,
  ...
  Map<String, dynamic> toJson() {
    return {
      "chat_messages_live_id": chat_messages_live_id,
      "sender_id": sender_id,
  ...
  factory GetAllSupportMessagesModel.fromJson(Map<String, dynamic> json) {
    return GetAllSupportMessagesModel(
      chat_messages_live_id: json["chat_messages_live_id"] ?? -1,
      ...
      status: json["status"] ?? '',
      user_data: UserData.fromJson(json["user_data"] ?? UserData()),
    );
  }
//
}
