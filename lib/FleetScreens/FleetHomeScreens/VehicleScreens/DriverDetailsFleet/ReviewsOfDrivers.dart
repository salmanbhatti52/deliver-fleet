...
class ReviewsOfDrivers extends StatefulWidget {
  const ReviewsOfDrivers({super.key});

  @override
  State<ReviewsOfDrivers> createState() => _ReviewsOfDriversState();
}

class _ReviewsOfDriversState extends State<ReviewsOfDrivers> {
    ...
    return isRankingLoading
        ...
        : ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              var formattedDate = DateFormat('MM/dd/yyyy').format(dateAdded);
